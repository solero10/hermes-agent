...
# The house-style rules, distilled from CONTRIBUTING.md / ARCHITECTURE.md
# "Skill authoring standards (HARDLINE)" and the hermes-agent-dev new-skill
# salvage reference. Embedded in the prompt so the agent authors skills the way
# a maintainer would by hand.
