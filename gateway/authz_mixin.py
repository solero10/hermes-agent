...
class GatewayAuthorizationMixin:
    ...
    def _adapter_for_source(self, source: Optional[SessionSource]):
        ...
        # SimpleNamespace and omit ``profile`` (see PITFALLS.md, "Bare test
        # doubles skip __init__").
    ...
    def _adapter_enforces_own_access_policy(
        ...
        *,
        ...
        # rather than raising (see PITFALLS.md, "Bare test doubles skip __init__").
        adapter = self._authorization_adapter(platform, profile)
        if adapter is None:
            return False
    ...
    def _is_user_authorized(self, source: SessionSource) -> bool:
        ...
        # mock sources) does not auto-truthy through this gate (see PITFALLS.md,
