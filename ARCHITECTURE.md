...
This file holds the detailed system map that used to live in the root
`AGENTS.md`. Use the compact root file for always-on instructions; use this
reference when you need subsystem-specific context.
