...
class HermesCLI(CLIAgentSetupMixin, CLICommandsMixin, CLIBillingMixin):
    ...
    def _read_codex_usage_status(self) -> str:
        ...
        producer refreshes this cache separately.
        """
        now = time.monotonic()
        ...
        try:
            ...
            if path.exists():
                # First line only; the producer writes a sanitized line, but
                # keep this reader defensive so a bad cache cannot wrap or
                # corrupt the prompt_toolkit footer.
