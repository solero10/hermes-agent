...
class TestToolHandler:
    ...
    def test_dead_server_lazy_reconnects_before_calling_tool(self):
        ...
        stale.session = None
        stale._registered_tool_names = ["mcp__srv__ping"]
...
class TestToolsetInjection:
    ...
    def test_dead_server_record_retried_on_subsequent_discovery(self):
        ...
        stale.session = None
        stale._registered_tool_names = ["mcp__cortexdb__search_thoughts"]
        stale._task = MagicMock()
        stale._task.done.return_value = True
        ...
        assert call_count == 1
        assert "mcp__cortexdb__search_thoughts" in result
    ...
    def test_running_reconnect_task_not_duplicated_by_discovery(self):
        ...
        reconnecting._registered_tool_names = ["mcp__cortexdb__search_thoughts"]
        ...
        assert result == ["mcp__cortexdb__search_thoughts"]
